...
function showMedianModal() {
    ...
    dom.medianAperture.value = session.aperture;
    dom.medianModal.classList.add('active');
}

// Закрытие модального окна
function closeMedianModal() {
    dom.medianModal.classList.remove('active');
}
...
function applyMedianFilter() {
    ...
    const aprture = parseInt(dom.medianAperture.value, 10);
    session.aperture = aprture;
...
function loadImage(e) {
    ...
    reader.onload = (e) => {
        ...
        img.onload = () => {
            ...
            createFileFromImageData(file.name, imageData);
